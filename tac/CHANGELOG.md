...
### Changed:
- Vomit damage will increase day by day.
...
### Changed:
- Slightly adjust early game revenue.
...
### Fixed:
- Fixed Mobia 3310 can be thrown infinitely.

### Changed:
- Update language content. (thanks to _Kpekep_)
...
### Changed:
- Upgrade Game Engine, due to the need to observe stability after the upgrade, there will be no content updates for the time being.
